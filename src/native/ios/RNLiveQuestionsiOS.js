...
const RNLiveQuestions = requireNativeComponent('RNLiveQuestions');

export default class RNLiveQuestionsiOSComponent extends React.Component {
  subscriptions = [];
  ...
  render() {
    return <RNLiveQuestions {...this.props} />;
  }
}
