...
export const RNLiveQuestionsAndroid = requireNativeComponent(
  'RNLiveQuestionsAndroid'
);

export default class RNLiveQuestionsComponentAndroid extends React.Component {
  nativeComponentRef;
  subscriptions = [];
