...
class PreviewCommentsView(context: Context) :
  ReactViewGroup(context), VFCustomUIInterface, VFActionsInterface, VFLayoutInterface, VFAdInterface {
  ...
  private val onArticlePressed by viafouraEvent()
  private val onAction by viafouraEvent()
  private val onAdSlotRequested by viafouraEvent()
